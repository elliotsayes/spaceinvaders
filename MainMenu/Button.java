...
public class Button {
    ...
    public Button(String buttonText, IntVector2D boxCoordinates, IntVector2D textOffset, IntVector2D buttonSize, int selection, ImageIcon unselectedImage, ImageIcon selectedImage, ImageIcon hoveredImage) {
